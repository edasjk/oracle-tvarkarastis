...
INSERT INTO station(station_id, station_name, address, stype) VALUES(station_sequence.NEXTVAL, 'Kaunas train station', 'M. K. Èiurlionio g. 16, Kaunas', (SELECT transport_id from transport WHERE ttype='Train'));
